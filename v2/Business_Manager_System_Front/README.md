# BusinessManager — Frontend (README)

> Sistema de gestão multi-negócios (Salão, Ginásio, TakeAway, Games).
> Frontend em React + Vite com layout administrativo responsivo (Sider desktop / Drawer mobile), Ant Design e animações com Framer Motion.

---

## 🚀 Visão geral

O **BusinessManager** é um painel administrativo para gerir vários negócios num único sistema:

* **Salão** (agendamentos, serviços)
* **Ginásio** (clientes, mensalidades)
...
* Componente de navegação central (`SideRoute`) que mapeia menus e submenus
* Avatar/nome do usuário no topo e no menu lateral
* Logout fixo no rodapé do Sider/Drawer
* Transições suaves com **Framer Motion**

---

## 🧭 Estrutura principal do repositório (sugestão)
